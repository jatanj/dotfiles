...
(gtk_accel_path "<Actions>/terminal-window/next-tab" "<Primary><Shift>Page_Down")
...
(gtk_accel_path "<Actions>/terminal-window/prev-tab" "<Primary><Shift>Page_Up")
(gtk_accel_path "<Actions>/terminal-window/move-tab-left" "<Primary><Shift>Home")
...
(gtk_accel_path "<Actions>/terminal-window/move-tab-right" "<Primary><Shift>End")
